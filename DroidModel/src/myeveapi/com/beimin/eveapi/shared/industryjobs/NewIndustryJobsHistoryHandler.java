...
public class NewIndustryJobsHistoryHandler extends
		AbstractContentListHandler<NewIndustryJobsHistoryResponse, ApiNewIndustryJob> {

	public NewIndustryJobsHistoryHandler() {
		super(NewIndustryJobsHistoryResponse.class);
	}
