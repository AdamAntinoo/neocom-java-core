...
/**
 * This model class will serve as the base placeholder for the NeoCom application nodes. Will define the common methods and
 * implement the default behavior for nodes.
 */
public class NeoComNode  implements ICollaboration, IJsonAngular {
	...
	public String toString () {
		StringBuffer buffer = new StringBuffer("NeoComNode [");
		buffer.append(" ]");
