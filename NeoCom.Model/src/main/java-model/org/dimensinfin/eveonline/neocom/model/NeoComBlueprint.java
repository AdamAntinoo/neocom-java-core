...
public class NeoComBlueprint extends NeoComNode {
	 ...
	 */
	@DatabaseField(index = true, generatedIdSequence = "blueprints_id_seq")
...
//	private int								manufacturableCount	= -1;
	...
	protected transient NeoComAsset associatedAsset = null;
	...
	public NeoComBlueprint( final int blueprintId ) {
		super();
		typeId = blueprintId;
		blueprintItem = accessGlobal().searchItem4Id(blueprintId);
		typeName = blueprintItem.getName();
		moduleTypeId = accessGlobal().searchModule4Blueprint(typeId);
		moduleItem = accessGlobal().searchItem4Id(moduleTypeId);
	 ...
	 *                    features.
	 */
	public NeoComBlueprint( final long blueprintId ) {
		assetId = blueprintId;
		try {
			...
			typeId = blueprintItem.getTypeId();
			typeName = blueprintItem.getName();
			moduleTypeId = accessGlobal().searchModule4Blueprint(typeId);
			moduleItem = accessGlobal().searchItem4Id(moduleTypeId);
			tech = this.obtainTech();
	...
	public String getCategoryName() {
		return this.getAssociatedAsset().getCategoryName();
	}
