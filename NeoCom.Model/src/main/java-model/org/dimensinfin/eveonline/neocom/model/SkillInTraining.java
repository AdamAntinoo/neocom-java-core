...
public class SkillInTraining extends NeoComNode {
	...
	public double getPctDone() {
		...
		if (startDate.isBeforeNow()) {
			...
			return (secondsDone / secondsTotal) * 100.0;
		} else return 0.0;
	}
	...
	public SkillInTraining setSkillId( int skillId ) {
		this.skillId = skillId;
		return this;
	}

	public SkillInTraining setFinishDate( DateTime finishDate ) {
		this.finishDate = finishDate;
		return this;
	}

	public SkillInTraining setStartDate( DateTime startDate ) {
		this.startDate = startDate;
		return this;
	}

	public SkillInTraining setFinishedLevel( int finishedLevel ) {
		this.finishedLevel = finishedLevel;
		return this;
	}

	public SkillInTraining setQueuePosition( int queuePosition ) {
		this.queuePosition = queuePosition;
		return this;
	}

	public SkillInTraining setTrainingStartSp( int trainingStartSp ) {
		this.trainingStartSp = trainingStartSp;
		return this;
	}

	public SkillInTraining setLevelEndSp( int levelEndSp ) {
		this.levelEndSp = levelEndSp;
		return this;
	}

	public SkillInTraining setLevelStartSp( int levelStartSp ) {
