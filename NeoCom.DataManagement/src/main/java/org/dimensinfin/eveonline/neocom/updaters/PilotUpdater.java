...
public class PilotUpdater extends NeoComUpdater<Pilot> {
	...
	public String getIdentifier() {
		return this.getModel().getJsonClass().toUpperCase() + ":" + this.getModel().getPilotId();
	}
	...
	public void onRun() {
		if (null != esiDataAdapter) {
			...
			// TODO - Check if the pilot shpuñd have the corporation and alliance data or if this belongs to the corporation
...
//			}
			...
			this.getModel().timeStamp(); // Update the last update event time.
		}
	}
}
