...
public abstract class PilotListPartFactory extends PartFactory {
	...
	public PilotListPartFactory(final EFragment variant) {
		super(variant);
	}
	...
	@Override
	public IEditPart createPart(final Object node) {
		return null;
	}
}
