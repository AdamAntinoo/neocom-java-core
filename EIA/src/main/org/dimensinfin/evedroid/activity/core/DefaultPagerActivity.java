		...
		try {
			...
			this._pageContainer.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
				...
				public void onPageSelected(final int position) {
					DefaultPagerActivity.this._actionBar
							.setTitle(DefaultPagerActivity.this._pageAdapter.getTitle(position));
					...
					if ("" == DefaultPagerActivity.this._pageAdapter.getSubTitle(position)) {
						...
						DefaultPagerActivity.this._actionBar
								.setSubtitle(DefaultPagerActivity.this._pageAdapter.getSubTitle(position));
					}
				}
			});
