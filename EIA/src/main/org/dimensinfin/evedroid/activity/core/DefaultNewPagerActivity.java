		...
		if (null != indicator) {
			...
			indicator.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
				...
				public void onPageSelected(final int position) {
					DefaultNewPagerActivity.this._actionBar
							.setTitle(DefaultNewPagerActivity.this._pageAdapter.getTitle(position));
					...
					if ("" == DefaultNewPagerActivity.this._pageAdapter.getSubTitle(position)) {
						...
						DefaultNewPagerActivity.this._actionBar
								.setSubtitle(DefaultNewPagerActivity.this._pageAdapter.getSubTitle(position));
					}
				}
			});
		} else {
