...
public class IndustryDirectorActivity extends PilotPagerActivity implements INeoComDirector {
	...
	//	public static Logger	logger		= Logger.getLogger("IndustryDirectorActivity");
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		try {
			// Get the number of blueprints of T3 and then T2 and T1 to activate the corresponding pages.
